...
export const options = {
    ...
    plugins: {
        ...
        title: {
            display: true,
            text: 'Burn down consistency',
        },
    },
};


function BDConsistency() {
    ...
    useEffect(() => {
        ...
        if (!isBDCDataFetched) {
            ...
            const baseUrl = "http://localhost:8081/getBDConsistency?Project="+searchParams.get("ProjectSlug")+"&Sprint="+searchParams.get("SprintName");
                ...
                .then((response) => {
                    ...
                    const tempGraphData = {
                        ...
                        datasets: [  //Values to be plotted
                            {
                                label: 'Normalized Value Burndown',
                                data: tempBVValues,
                                borderColor: 'rgb(255, 99, 132)',
                                backgroundColor: 'rgba(255, 99, 132, 0.5)',
                            },
                            {
                                label: 'Normalized Work Burndown',
                                data: tempSPValues,
    ...
    if (!isBDCDataFetched) {
        return (
            <div> BDConsistency graph loading...</div>
        )
    }
