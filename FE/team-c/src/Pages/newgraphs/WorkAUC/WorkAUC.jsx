...
function WorkAUC() {
    ...
    useEffect(() => {
        ...
        if (!isBDCDataFetched) {
            ...
            const baseUrl = "http://localhost:8082/getAUC?Project="+searchParams.get("ProjectSlug")+"&Sprint="+searchParams.get("SprintName");
    ...
    if (!isBDCDataFetched) {
        return (
            <div> Work AUC graph loading...</div>
        )
    }
